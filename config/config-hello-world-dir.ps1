# creates symbolic link for a directory

$source = "../files/hello-world-dir"  # Change to the source directory
$target = "$HOME/programs/hello-world-dir"  # Change to the target directory
